...
KSRC_linux_yocto_3_4 = "github.com/lsigithub/lsi_axxia_yocto_public.git"
SRC_URI_${MACHINE} = "git://${KSRC_linux_yocto_3_4};protocol=https;bareclone=1;branch=${KBRANCH};name=machine"
